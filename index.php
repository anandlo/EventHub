            ...
            <div class="swiper sliderFeaturedPosts">
              <div class="swiper-wrapper">
                ...
                <?php
                  ...
                  //Query that selects rows that has most recent SubmitDate from the groups table
                  $events = "SELECT * FROM events ORDER BY SubmitDate DESC LIMIT 1";
                  ...
                  echo <<<HTML
                  <div class="swiper-slide">
                    <a href="single-post.php?number=$eventID" class="img-bg d-flex align-items-end" style="background-image: url('assets/img/post-slide-2.jpg');">
                    <div class="img-bg-inner">
                      <h2>Happening Soon</h2>
                      <p><b>$eventTitle:</b> $eventDesc</p>
                    </div>
                    </a>
                  </div>
                  HTML;
                ...
                <?php
                  ...
                  //Select the event that is happening in the future or today
                  $events = "SELECT * FROM events WHERE EventDate>=CURDATE() ORDER BY EventDate ASC LIMIT 1";
                  $result = mysqli_query($conn, $events);
                  ...
                  echo <<<HTML
                  <div class="swiper-slide">
                    <a href="single-post.php?number=$eventID" class="img-bg d-flex align-items-end" style="background-image: url('assets/img/post-slide-3.jpg');">
                    <div class="img-bg-inner">
                      <h2>Happening Soon</h2>
                      <p><b>$eventTitle:</b> $eventDesc</p>
                    </div>
