      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-9" data-aos="fade-up">
            <!--Changed the name to CATEGORY: ADD-->
            <h3 class="category-title">
              <?php 
                $varGroupName = $_GET['target'];
                //Check if all events or event is clicked and display category type accordingly
                if($varGroupName === '')
                {
                  echo"Event Category: All";
                }
                //Check which category is selected and display the category
                else{
                  echo"Event Category: " . $varGroupName;
                }
              ?>
            </h3>
            ...
            <?php
              ...
              //Fetch the number of the event using querystring and store it into varGroupName
              $varGroupName = $_GET['target'];
              ...
              while ($row = $result->fetch_assoc()) {
                ...
                $formattedDateTime = date_format($dateTime, 'd-M-y h:i A');//[3]
                ...
                //Check if the event type matches the target querystring or if target querystring is empty
                if (($varGroupName === $event_Type || $varGroupName === '') && ($eventDate>=$currentDateTime)) {
                  
                  //Display the information using HEREDOC
                  echo <<<HTML
                  <div class="d-md-flex post-entry-2 half">
                    <a href="single-post.php?number=$eventID" class="me-4 thumbnail">
                    ...
                    <div>
                      ...
                      <h3><a href="single-post.php?number=$eventID">$eventTitle</a></h3>
